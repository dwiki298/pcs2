package com.amikom.www.apaccess._sliders;
...
import com.amikom.www.apaccess.R;
import com.bumptech.glide.Glide;

/**
 * Created by amikom on 12/04/17.
 */
...
public class FragmentSlider extends Fragment { // implements View.OnTouchListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Uri uri = Uri.parse("android.resource://com.amikom.www.apaccess/drawable/"+imageUrls);
